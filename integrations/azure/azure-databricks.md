...
Now, when you log into your LOGIQ UI, you should see the logs from your Azure Databricks cluster being ingested. See the [Explore](../../log-management/explore-logs/) Section to view the logs.
