...
logiq-repo/logiq    2.2.2            2.1.1          LOGIQ Observability HELM chart for Kubernetes
```
...
{% file src="../.gitbook/assets/values.small \(9\).yaml" %}

{% file src="../.gitbook/assets/values.medium \(7\).yaml" %}
